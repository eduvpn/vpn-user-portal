...
<?php $this->start('content'); ?>
    ...
    <p>
        ...
        that needs to be provided on every login to the portal. This function
        needs to be enabled by the server administrator.
    </p>
    <p>
    ...
    <ul>
        <li>
            <a target="_blank" href="https://addons.mozilla.org/en-US/firefox/addon/ublock-origin/">uBlock Origin</a>:
        ...
        <li>
            <a target="_blank" href="https://addons.mozilla.org/en-US/firefox/addon/https-everywhere/">HTTPS Everywhere</a>:
        ...
        <li>
            <a target="_blank" href="https://addons.mozilla.org/en-US/firefox/addon/noscript/">NoScript Security Suite</a> (<em>Advanced Users</em>):
