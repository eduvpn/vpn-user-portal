 ...
 * authenticated user.
 *
 * This is the LEGACY version that defers obtaining the groups to the
 * backend. This WILL be removed in the near future.
 */
class LegacyVootTokenHook implements BeforeHookInterface
{
