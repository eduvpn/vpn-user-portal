...
return [
    ...
    // [DELETED] 'All users will see this "Message of the Day" (MOTD) message when logging in to the portal, or when connecting to the VPN using an application supporting the API.' => 'Wszyscy użytkownicy będą widzieć poniższą wiadomość dnia (MOTD) gdy zalogują się do portalu lub połączą z VPN za pomocą aplikacji z obsługą API.',
    // [DELETED] 'ID' => 'Identyfikator',
    // [DELETED] 'MOTD' => 'Wiadomość dnia (MOTD)',
    // [DELETED] 'Summary' => 'Podsumowanie',
    // [DELETED] 'System' => 'System',
    // [DELETED] 'There are no users with VPN configurations.' => 'Brak użytkowników z konfiguracjami VPN.',
    // [DELETED] 'This is a list of events that occurred related to this user account.' => 'Lista zarejestrowanych zdarzeń związanych z tym kontem.',
    // [DELETED] 'This is a list of events that occurred related to your account.' => 'Lista zarejestrowanych zdarzeń związanych z Twoim kontem.',
    // [DELETED] 'This user does not have any configurations.' => 'Ten użytkownik nie ma żadnych konfiguracji.',
    // [DELETED] 'Type' => 'Typ',
