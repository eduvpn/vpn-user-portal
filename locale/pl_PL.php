...
return [
    '<strong title="%client_id%">%display_name%</strong> wants to manage your VPN configurations.' => '<strong title="%client_id%">%display_name%</strong> chce zarządzać Twoją konfiguracją VPN.',
    'Account' => 'Konto',
    'Active' => 'Aktywny',
    ...
    'Download' => 'Pobierz',
    'Download a new VPN configuration by choosing a profile and a name, e.g. <em>Phone</em>.' => 'Pobierz nową konfigurację VPN określając profil połączenia i podając nazwę, np. <em>Telefon</em>.',
    'Either, no VPN profiles are defined, or this account does not have the required permissions to access any of the available profiles.' => 'Nie zdefiniowano żadnego profilu połączenia lub konto nie ma wymaganych uprawnień do dostępu do bieżących profili.',
    ...
    'Managing user <em>%userId%</em>.' => 'Zarządzanie użytkownikiem <em>%userId%</em>.',
    'Message' => 'Wiadomość',
    'Messages' => 'Wiadomości',
    'N/A' => 'brak',
    'Name' => 'Nazwa',
    ...
    'There are currently no issued certificates. <a href="new">Download</a> a new configuration.' => 'Aktualnie nie masz żadnych certyfikatów. <a href="new">Pobierz</a> nową konfigurację.',
    ...
    'These statistics were last updated on %generated_at% (%generated_at_tz%) and cover the last month.' => 'Statystyki zostały zaktualizowane %generated_at% (%generated_at_tz%) i obejmują ostatni miesiąc.',
    'This is a list of events that occurred related to this user account.' => 'Lista zarejestrowanych zdarzeń związanych z tym kontem.',
    'This is a list of events that occurred related to your account.' => 'Lista zarejestrowanych zdarzeń związanych z Twoim kontem.',
    ...
    'User ID' => 'Użytkownik',
    'User Info' => 'Dane użytkownika',
    'Username' => 'Nazwa użytkownika',
    'Users' => 'Użytkownicy',
    'VPN Portal' => 'Portal VPN',
    'VPN traffic over the last month.' => 'Ruch sieciowy w ostatnim miesiącu.',
    'VPN usage statistics not (yet) available. Check back after midnight.' => 'Statystyki użycia VPN nie są jeszcze dostępne. Sprawdź jutro.',
    'Verify' => 'Zweryfikuj',
    'Yes' => 'Tak',
    ...
    // [DELETED] 'Highest # Concurrent Connections' => 'Największa liczba jednoczesnych połączeń',
    // [DELETED] 'The <em>Date/Time</em> field accepts dates of the format <code>Y-m-d H:i:s</code>, e.g. <code>%currentDate%</code>. Use <em>UTC</em> as the time zone.' => 'Pole <em>Data/czas</em> akceptuje daty w formacie <code>Y-m-d H:i:s</code>, np. <code>%currentDate%</code>. Proszę podawać czas w strefie <em>UTC</em>.',
];
