...
return [
    ...
    'Highest # Concurrent Connections' => 'Największa liczba jednoczesnych połączeń',
    'ID' => 'Identyfikator',
    'IP Address' => 'Adres IP',
    'IP address' => 'adres IP',
    'IPs' => 'IP',
    ...
    'System' => 'System',
    'TOTP' => 'TOTP',
    'The <em>Date/Time</em> field accepts dates of the format <code>Y-m-d H:i:s</code>, e.g. <code>%currentDate%</code>. Use <em>UTC</em> as the time zone.' => 'Pole <em>Data/czas</em> akceptuje daty w formacie <code>Y-m-d H:i:s</code>, np. <code>%currentDate%</code>. Proszę podawać czas w strefie <em>UTC</em>.',
