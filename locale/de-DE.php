...
return [
    ...
    'CPU Usage:' => 'Prozessor-Auslastung',
    ...
    'Currently there are no clients connected to this profile.' => 'Derzeit sind keine Clients über dieses Profil verbunden.',
    ...
    'Enable Account' => 'Aktiviere Benutzeraccount',
    'Error' => 'Fehler',
    ...
    'This server uses an external authentication source. Deleting the account data will not prevent the user from authenticating (again)!' => 'Dieser Server greift auf eine externe Authentifizierung zurück. Den Benutzeraccount zu löschen verhindert nicht, dass sich die Benutzer einen neuen Zugang erstellen können!',
    'This user does not have any active configurations.' => 'Dieser Nutzende hat keine aktive Konfiguration',
    'This user does not have any connections.' => 'Dieser Nutzende hat aktuell keine Verbindungen etabliert',
    'To prevent malicious applications from secretly establishing a VPN connection on your behalf, you have to explicitly approve this application first.' => 'Um Schadsoftware davon abzuhalten automatisiert eine VPN-Verbindung herzustellen, musst Du dies explizit dieser Anwendung genehmigen.',
    ...
    'You have reached the maximum number of allowed active VPN configurations. Delete some first.' => 'Du hast die maximale Anzahl der zulässigen aktiven VPN Profile erreicht. Um ein neues zu erstellen, lösche zuerst ein ungenutztes Profil.',
    'Your account does not have access to any VPN profile.' => 'Du hast noch kein VPN Profil mit deinem Benutzeraccount generiert.',
    'Your new configuration will expire on %expiryDate%. Come back here to obtain a new configuration after expiry!' => 'Deine neue Konfiguration wird am %expiryDate% ungültig. Erstelle erneut eine Konfiguration, sobald die aktuelle ungültig ist.',
];
