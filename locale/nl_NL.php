...
return [
    ...
    'Prevent account from using this VPN server and revoke all authorized applications.' => 'Sta het account niet langer toe deze VPN-server te gebruiken en verwijder alle geautoriseerde applicaties.',
    'Profile' => 'Profiel',
    ...
    'Results' => 'Resultaten',
    'Revoke' => 'Intrekken',
    'Revoke Certificates' => 'Certificaten intrekken',
    'Revoke all certificates obtained by the user through "Configurations".' => 'Trek alle certificaten in die door de gebruiker zijn verkregen via "Configuraties".',
    'Route(s)' => 'Route(s)',
