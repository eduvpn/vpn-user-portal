...
return [
    ...
    // [DELETED] 'Highest # Concurrent Connections' => 'Найбільша кількість одночасних з’єднань',
    // [DELETED] 'The <em>Date/Time</em> field accepts dates of the format <code>Y-m-d H:i:s</code>, e.g. <code>%currentDate%</code>. Use <em>UTC</em> as the time zone.' => 'Поле <em>Дата/час</em> приймає дату в форматі <code>Р-м-в Ч:хв:с</code>, наприклад <code>%currentDate%</code>. Будь ласка, введіть час у зоні <em>UTC</em>.',
];
