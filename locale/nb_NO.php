...
return [
    ...
    // [DELETED] '<strong title="%client_id%">%display_name%</strong> wants to manage your VPN configurations.' => '<strong title="%client_id%">%display_name%</strong> vil styre dine instillinger for VPN.',
    // [DELETED] 'Approve' => 'Tillat',
    // [DELETED] 'Download' => 'Last ned',
    // [DELETED] 'Download a new VPN configuration by choosing a profile and a name, e.g. <em>Phone</em>.' => 'Lag en ny VPN-konfigurasjon ved å velge en profil og fylle ut navn, for eksempel <em>Telefon</em>.',
    ...
    // [DELETED] 'Issued' => 'Utstedt',
    // [DELETED] 'Managing user <em>%userId%</em>.' => 'Styrer bruker <em>%userId%</em>.',
    // [DELETED] 'New' => 'Ny',
    // [DELETED] 'Reject' => 'Avslå',
    // [DELETED] 'There are currently no issued certificates. <a href="new">Download</a> a new configuration.' => 'Ingen konfigurasjon tilgjengelig. <a href="new">Opprett</a> ny.',
];
