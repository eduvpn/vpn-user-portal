...
return [
    ...
    'System' => 'System',
    'TOTP' => 'TOTP',
    'The <em>Date/Time</em> field accepts dates of the format <code>Y-m-d H:i:s</code>, e.g. <code>%currentDate%</code>. Use <em>UTC</em> as the time zone.' => 'Dato/Tid-feltet tar dato i format <code>Y-m-d H:i:s</code>, f.eks <code>%currentDate%</code>. Tidssonen er UTC.',
    ...
    // [DELETED] 'Approval' => 'Tillatelse',
    // [DELETED] 'See the <a href="documentation">documentation</a> for more information on 2FA and a list of applications to use.' => 'Se <a href="documentation">dokumentasjonen</a> for å finne ut mer om 2FA og ei liste med applikasjoner som kan brukes.',
    // [DELETED] 'VPN User Portal' => 'VPN-Brukerportal',
];
